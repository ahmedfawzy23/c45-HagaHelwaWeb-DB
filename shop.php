...
$result = mysqli_query($conn, "SELECT products.*, categories.name_en as category_en FROM products
    ...
    <section id="pagenation" class="section-p1">
        ...
        <?php if ($totalPages > 1) { ?>
            <?php for ($i = 1; $i <= $totalPages; $i++) {
                ...
                echo "<a style='margin: 0 5px;' href='shop.php?page=$i'>$i</a>";
            } ?>
